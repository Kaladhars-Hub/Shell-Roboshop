...
curl -L -o /tmp/cart.zip https://roboshop-artifacts.s3.amazonaws.com/cart-v3.zip &>>"$LOG_FILE"  # ✅ FIXED: Added &>>"$LOG_FILE" and line break
VALIDATE $? "Download application"

cd /app && unzip -o /tmp/cart.zip &>>"$LOG_FILE"
